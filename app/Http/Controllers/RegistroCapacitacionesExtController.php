...
class RegistroCapacitacionesExtController extends Controller
{
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard')->with('success', 'La capacitación se registró correctamente.');
    }
    ...
    public function index()
    {
        ...
        return view('datos.datos', compact('capacitaciones'));
    }
    ...
    {
        $query = DB::table('registrocapacitacionesext'); // Cambiar a la tabla correcta
        ...
        return view('datos.datos', ['capacitaciones' => $capacitaciones]);
    }

    public function create()
    {
        $userEmail = auth()->check() ? auth()->user()->email : null;
        return view('datos.formulario', compact('userEmail'));

        return view('tu.vista', compact('datosGenerales'));
    }
    ...
    public function actualizarStatus(Request $request, $id)
    {
        ...
        $capacitacion = RegistroCapacitacionesExt::findOrFail($id);  // Aquí usas el modelo correcto
