                ...
                <div class="mt-4">
                    ...
                    <div class="mt-2">
                        @foreach ($roles as $role)
                            @foreach ($usuario->user_roles as $roles)
                                @if ($role->nombre == "admin" and $roles->nombre == 'admin')
                            ...
                            <label class="block mb-2">
                                <input type="checkbox" name="roles[]" value="{{ $role->id }}"
                                    class="form-checkbox h-4 w-4 text-indigo-600" {{ $usuario->roles->contains($role->id) ? 'checked' : '' }} />
